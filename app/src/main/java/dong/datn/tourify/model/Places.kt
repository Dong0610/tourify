...
fun createFamousPlaces(): MutableList<Places> {
    return mutableListOf(
        ...
        Places(
            placeID = "place_11",
            placeName = "Quảng Ninh",
            description = "Tỉnh Quảng Ninh nổi tiếng với Vịnh Hạ Long, di sản thế giới được UNESCO công nhận với cảnh quan thiên nhiên tuyệt đẹp.",
            listTour = mutableListOf("tour_id_001", "tour_id_002", "tour_id_003"),
            Image = mutableListOf(
                "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQtEz_1szcUItETaxYqE2O595DsDnJfHeMGjQ&s",
                "https://sinhcafe-thesinhtourist.vn/wp-content/uploads/2024/05/a-n.jpg"
            ),
            tourCount = 2,
            createdTime = "2023-06-23"
        ),
        Places(
            placeID = "place_12",
            placeName = "Hải Phòng",
            description = "Thành phố cảng lớn nhất miền Bắc Việt Nam, nổi tiếng với những địa điểm như bãi biển Đồ Sơn và vườn quốc gia Cát Bà.",
            listTour = mutableListOf("tour_id_001", "tour_id_002", "tour_id_003"),
            Image = mutableListOf(
                "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSgpBFI0jueqIa66PqYTZnaIUnLbgASSRxlnw&s",
                "https://dulichbennghe.cdn.vccloud.vn/wp-content/uploads/2020/03/du-lich-ben-nghe-du-lich-vinh-ha-long2-1.jpg"
            ),
            tourCount = 2,
            createdTime = "2023-06-23"
        ),
        Places(
            placeID = "place_13",
            placeName = "Thanh Hóa",
            description = "Tỉnh Thanh Hóa nổi tiếng với các di tích lịch sử và thắng cảnh như khu di tích Lam Kinh và bãi biển Sầm Sơn.",
            listTour = mutableListOf("tour_id_001", "tour_id_002", "tour_id_003"),
            Image = mutableListOf(
                "https://hdtransport.vn/hinhanh/sanpham/thue-xe-du-lich-sam-son.jpg",
                "https://cdn.tgdd.vn/Files/2021/07/05/1365849/kinh-nghiem-du-lich-bien-sam-son-thanh-hoa-202107051711370824.jpg"
            ),
            tourCount = 2,
            createdTime = "2023-06-23"
        ),
        ...
        Places(
            placeID = "place_14",
            placeName = "Bình Định",
            description = "Tỉnh Bình Định nổi tiếng với các bãi biển đẹp, di tích lịch sử và văn hóa như tháp Chăm và bãi biển Ky Co.",
            listTour = mutableListOf("tour_id_001", "tour_id_002", "tour_id_003"),
            Image = mutableListOf(
                "https://cdn.tgdd.vn/Files/2021/07/09/1366895/tong-hop-10-dia-diem-du-lich-dep-nhat-tai-binh-dinh-202309121553084106.jpg",
                "https://dulichvn.org.vn/nhaptin/uploads/images/2019/thang7/baibienkyco1.jpg"
            ),
            tourCount = 2,
            createdTime = "2023-06-23"
        ),
        Places(
            ...
            description = "Tỉnh Kiên Giang nổi tiếng với các đảo lớn như Phú Quốc và các bãi biển tuyệt đẹp như bãi biển Rạch Giá.",
            listTour = mutableListOf("tour_id_001", "tour_id_002", "tour_id_003"),
            Image = mutableListOf(
                "https://image.sggp.org.vn/w1000/Uploaded/2024/evofjasfzyr/2023_01_03/anh-du-lich-kien-giang-9675.jpg.webp",
                "https://mytourcdn.com/upload_images/Image/Location/20_2_2016/5-du-lich-bien-dao-kien-giang-mytour-1.jpg"
            ),
            tourCount = 2,
            createdTime = "2023-06-23"
        ),
        Places(
            placeID = "place_16",
            placeName = "Sơn La",
            description = "Tỉnh Sơn La nổi tiếng với các cảnh quan núi non hùng vĩ, các bản làng dân tộc và khu du lịch Mộc Châu.",
            listTour = mutableListOf("tour_id_001", "tour_id_002", "tour_id_003"),
            Image = mutableListOf(
                "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRYFOxBXffdTh17_aJA_rvuDzBJbkPB4B19kg&s",
                "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQdb-KcBRDcKLKzSBmF1hqx2jLZn_pxomCaAFYp2bsiGzSCW8NZdmnIOI1EoBF5O56WQ_U&usqp=CAU"
            ),
            tourCount = 2,
            createdTime = "2023-06-23"
        ),
        Places(
            placeID = "place_17",
            placeName = "Lào Cai",
            description = "Tỉnh Lào Cai nổi tiếng với thị trấn Sa Pa, một điểm đến du lịch nổi tiếng với phong cảnh núi non tuyệt đẹp và các bản làng dân tộc.",
            listTour = mutableListOf("tour_id_001", "tour_id_002", "tour_id_003"),
            Image = mutableListOf(
                "https://lh3.googleusercontent.com/proxy/tmoLwp3vSsjEKV7t0G3TM42mbEffcLBmac3fT-BHjhdLL-7kUnDuWV_ratKZ5ruaLox1KQ5yOnmaiCBkHM6wUK55ukSepFiPdbHQzhEdRw",
